...
PS_OUT PS_MAIN_NORMAL_Plant(PS_IN_NORMAL In)
{
    PS_OUT Out = (PS_OUT) 0;
...
technique11 DefaultTechnique
{
    ...
    {   // 3
        ...
        VertexShader = compile vs_5_0 VS_MAIN();
        GeometryShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_NORMAL_Plant();
    }
